(() => {
  ...
  document.addEventListener("submit", async (event) => {
    ...
    if (form.id === "castCardForm") return gameAction({ type: "cast-card", cardId: data.get("cardId"), fromZone: data.get("fromZone"), targets: data.getAll("targets") });
