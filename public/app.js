  ...
  function renderHome() {
    ...
    return `
      <section class="hero-panel arena-hero">
        <div><p class="eyebrow">Arena Commander v30 • 2–6 Players</p><h1>A full digital Commander table built for phones, tablets and desktop.</h1><p>Real cards, shared stack and priority, assisted combat, clockwise turns, drag-and-drop, spectators, replays and persistent games.</p></div>
